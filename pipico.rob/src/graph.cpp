...
float node_coords[N_nodes + 1][2] = {
    ...
    // {0.227f,    0.0f}, // Node 42
    // {0.468f,    0.0f}, // Node 43
    {0.245f, -0.315f}, // Node 23
    {0.395f, -0.315f}, // Node 24
    {0.545f, -0.315f}, // Node 25
    {0.695f, -0.315f}, // Node 26
    {0.245f, -0.365f}, // Node 36
    {0.395f, -0.365f}, // Node 37
    {0.545f, -0.365f}, // Node 38
    {0.695f, -0.365f}, // Node 39
