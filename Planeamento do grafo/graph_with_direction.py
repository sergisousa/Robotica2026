...
PHYSICAL_COORDS: Dict[int, Tuple[float, float]] = {
    4:(0.0,0.355), 5:(0.695,0.355), 6:(0.0,0.15), 7:(0.127,0.0),
    8:(0.567,0.15), 9:(0.695,0.15), 13:(0.0,0.0), 14:(0.127,0.15),
    15:(0.567,0.0), 16:(0.695,0.0), 20:(0.0,-0.15), 22:(0.0,-0.250),
    23:(0.245,-0.250), 24:(0.395,-0.250), 25:(0.545,-0.250), 26:(0.695,-0.250),
    36:(0.245,-0.355), 37:(0.395,-0.355), 38:(0.545,-0.355), 39:(0.695,-0.355),
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    plt.savefig('grafo_rotações.png', dpi=150)
    plt.show()
